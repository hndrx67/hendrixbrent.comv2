...
(function() {
    ...
    // We want the verification to show every time, so we removed the localStorage check
    ...
    // When user clicks proceed, hide the overlay
    proceedButton.addEventListener('click', function() {
        if (ageCheckbox.checked) {
            ...
            // We don't store verification in localStorage anymore
            // We want the popup to appear every time
        }
    });
