...
const umas = [
    ...
    { rank: 1,  name: 'Maruzensky',           image: './umas/mommymaruzenskyyyyy.jpg', note: '', gooned: 112, trend: 'up' },
    { rank: 2,  name: 'Daiwa Scarlet',        image: './umas/daiwa-scarlet-wife.jpg', note: '', gooned: 20, trend: 'up' },
    { rank: 3,  name: 'Kitasan Black',        image: './umas/KitasanBlackIcon1.jpg', note: '', gooned: 16, trend: 'up' },
    { rank: 4,  name: 'Satono Diamond',       image: './umas/SatonoDiamond.jpg', note: '', gooned: 16, trend: 'up' },
    { rank: 5,  name: 'Tokai Teio',           image: './umas/tokaiteiomybeloved1.jpg', note: '', gooned: 13, trend: 'up' },
    { rank: 6,  name: 'Rice Shower',          image: './umas/riceshowermydaughter.jpg', note: '', gooned: 13, trend: 'up' },
    ...
    { rank: 10, name: 'Symboli Rudolph',      image: './umas/SymboliRudolf.jpg', note: '', gooned: 11, trend: 'down' },
    { rank: 11, name: 'Tamamo Cross',         image: './umas/', note: '', gooned: 11, trend: 'down' },
    { rank: 12, name: 'Biwa Hayahide',        image: './umas/', note: '', gooned: 10, trend: 'down' },
    { rank: 13, name: 'Mayano Top Gun',       image: './umas/', note: '', gooned: 10, trend: 'down' },
    { rank: 14, name: 'Manhattan Café',       image: './umas/', note: '', gooned: 9, trend: 'down' },
    { rank: 15, name: 'Agnes Tachyon',        image: './umas/', note: '', gooned: 8, trend: 'down' },
    { rank: 16, name: 'Gold City',            image: './umas/', note: '', gooned: 7, trend: 'down' },
    { rank: 17, name: 'Sweep Tosho',          image: './umas/', note: '', gooned: 7, trend: 'down' },
    { rank: 18, name: 'Tosen Jordan',         image: './umas/', note: '', gooned: 7, trend: 'down' },
    { rank: 19, name: 'Marvelous Sunday',     image: './umas/', note: '', gooned: 7, trend: 'down' },
    { rank: 20, name: 'Meisho Doto',          image: './umas/', note: '', gooned: 7, trend: 'down' },
    { rank: 21, name: 'Nice Nature',          image: './umas/', note: '', gooned: 6, trend: 'down' },
    { rank: 22, name: 'Daitaku Helios',       image: './umas/', note: '', gooned: 6, trend: 'down' },
    { rank: 23, name: 'Twin Turbo',           image: './umas/', note: '', gooned: 6, trend: 'down' },
    { rank: 24, name: 'Matikanetannhauser',   image: './umas/', note: '', gooned: 6, trend: 'down' },
    { rank: 25, name: 'Happy Meek',           image: './umas/', note: '', gooned: 1, trend: 'down' },
];
