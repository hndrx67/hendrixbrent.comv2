// ba-navbar-hide.js - hide/show top navbar on scroll (copied from uma-navbar-hide.js)
(function(){
  'use strict';
  ...
  let lastScroll = 0;
  let ticking = false;
  const HIDE_THRESHOLD = 12; // px delta before we hide
  const TOP_THRESHOLD = 24; // always show when near top
